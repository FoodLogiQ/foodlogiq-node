  ...
  return {
    ...
    addDocument: function(businessId, stockRecoveryId, file, callback){
      var readStream = fs.createReadStream(file.path)
        ,  url       = '/businesses/' + businessId + '/stockRecoveries/' + stockRecoveryId + '/documents';
      var parts = {
        document: readStream,
        filename: file.name
      };
    ...
    deleteDocument: function( businessId, stockRecoveryId, documentId, callback ) {
      conn.delete('/businesses/'+businessId+'/stockRecoveries/'+stockRecoveryId+'/documents/'+documentId, callback);
    },
